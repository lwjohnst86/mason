...
doesn't need to be. It was also designed to follow the [tidy data philosophy](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html),
...
convention `add_settings.statmethod_blueprint` and include the appropriate
...
`construct_analysis` and `scrub` S3 method.
